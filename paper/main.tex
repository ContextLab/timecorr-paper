...
http://arks.princeton.edu/ark:/88435/dsp015d86p269k.  The dataset
...
of the data.  In brief, this approach approximates the timeseries of voxel
activations (44,415 voxels) using a much smaller number of radial
basis function nodes (in this case 700 nodes).  This provides a convenient
...
this lower-dimensional space. \textbf{JRM STOPPED HERE}

\subsection*{Temporal decoding}
\subsubsection*{Forward inference, cross validation, and feature selection}
