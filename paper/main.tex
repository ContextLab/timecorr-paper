...
In general, wide monotonic kernel shapes (Laplace, Gaussian)\textbf{, and
...
\textbf{Following a similar patterns, holding kernel shape fixed,
  narrower kernel parameters better recovered randomly varying
  correlations.}
...
tiredness; we hypothesize these all increase throughout the resting
...
\textit{higher-order} network dynamics that reflect ongoing cognition.  Our
...
data provides a window into the neural basis of cognition.  By showing
...
Fitzpatrick, Andrew Heusser, Eshin Jolly, Aaron Lee, Qiang Liu,
Matthijs van der Meer, Judith Mildner, Gina Notaro, Stephen
