...
\begin{figure}[tp]
  ...
  simulated correlation first and second order correlation matrices.   \textbf{d. Event-based correlations.}  These first and second order dynamic correlation were
    simulated from datasets are
