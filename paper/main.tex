...
which preserves an approximately invertible transformation back to the
...
scrambled stories or resting state data, only lower-order dynamic
...
>>>>>>> b0208596a8113ff0d4d3e896fa4e49f5f4d014cd
...
reflected in patterns of $n^\mathrm{th}$-order correlations.
...
\begin{figure}
  ...
  \caption{\textbf{Estimating dynamic high-order correlations.}  Given
    ...
    iteratively higher-order correlations in the data.}
  \label{fig:methods}
\end{figure}
...
$\eta: \mathcal{R}^{K \times K} \rightarrow \mathbb{R}^K$, we can use
=======
...
<<<<<<< HEAD
approach (Fig.~\ref{fig:methods}). \textbf{JRM STOPPED HERE}
...
features support ongoing cognitive processing is governed by many
