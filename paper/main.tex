...
\begin{align}
Y_{n+1,t} = vec(\mathbf{\Sigma}_{n,t})\cdot vec(\mathbf{\Sigma}_{n,t})^\top\label{eqn:veccorr}
  \end{align}

 Observations were then drawn at each timepoint from a  ${ Y_{n,t}}$-mean multivariate Gaussian distribution with a
covariance matrix defined as ${ Y_{n+1,t}}$.  
