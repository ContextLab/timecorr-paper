...
\begin{figure}[p!]
\centering
\includegraphics[width=0.75\textwidth]{figs/decode_levels_kernels}
\caption{\textbf{Across-participant decoding accuracy varies with
      correlation order and cognitive engagement across kernels}  \textbf{a-d..~Decoding accuracy as a function of order: PCA.}\textit{Order} ($x$-axis) refers to the maximum order of dynamic
...
\begin{figure}[p!]
\centering
\includegraphics[width=0.75\textwidth]{figs/decode_levels_widths}
