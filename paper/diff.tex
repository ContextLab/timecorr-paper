...
%DIF ADD main.tex   Thu Aug 12 15:01:10 2021
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{hyperref}
\usepackage{setspace}
...
of 50 (\DIFdelbegin \DIFdel{Fig.~\ref{fig:kernels}d; also see }\DIFdelend \DIFaddbegin \DIFadd{see Kernel-based approach for computing dynamic correlations and }\DIFaddend Fig.~\pca).  We used this kernel to compute a
