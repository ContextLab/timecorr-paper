...
%DIF ADD main.tex   Thu Aug  5 19:45:31 2021
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{hyperref}
\usepackage{setspace}
...
\DIFdelend \DIFaddbegin \DIFadd{Feature
  weighting and testing}\DIFaddend , Fig.~\ref{fig:pipeline}).  We repeated this process for
...
\DIFadd{and has been deposited in the Zenodo database under accession code }\href{https://doi.org/10.5281/zenodo.5165253}{\DIFadd{https://doi.org/10.5281/zenodo.5165253}}\DIFadd{.
...
\DIFadd{The authors declare no competing financial interests.
}
