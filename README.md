...
3. Build the docker image by opening a terminal in this repo folder and enter `docker build -t timecorr .`  
4. Use the image to create a new container for the workshop
    ...
    - `docker run -it -p 9999:9999 --name Timecorr -v ~/Desktop:/mnt timecorr `
...
1. You can always fire up the container by typing the following into a terminal
    - `docker start Timecorr && docker attach Timecorr`
