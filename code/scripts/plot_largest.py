...
for c in conditions:
    ...
    b1 = se.load(os.path.join(bo_dir,f'{c}_1_largest.bo'))
    b2 = se.load(os.path.join(bo_dir,f'{c}_2_largest.bo'))
    b3 = se.load(os.path.join(bo_dir,f'{c}_3_largest.bo'))
    b4 = se.load(os.path.join(bo_dir,f'{c}_4_largest.bo'))
    ...
    sc.screenshot(os.path.join(n_f_dir, f'{c}_largest.png'), transparent=True)
